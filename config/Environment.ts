export class Environment {
    ...
    static readonly EMPLOYED_USERNAME = Environment.getRequired('EMPLOYED_USERNAME')
    static readonly EMPLOYED_PASSWORD = Environment.getRequired('EMPLOYED_PASSWORD')
